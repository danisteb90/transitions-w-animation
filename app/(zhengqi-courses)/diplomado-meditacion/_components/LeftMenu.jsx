...
const LeftMenu = () => {
	...
	return (
		<section className="fixed xl:top-0 bottom-0 left-0 xl:w-[120px] w-full h-[100px] bg-[var(--zen-base)] xl:h-screen flex xl:flex-col justify-between items-center shadow-lg shadow-black px-3 z-[1]">

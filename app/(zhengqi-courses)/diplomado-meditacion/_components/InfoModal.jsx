	...
	return (
		<>
			<div className="absolute bottom-[10px] left-[50%] translate-x-[-50%] flex items-center justify-center z-[1]">
				<div className="bg-[var(--zen-analog2)] p-[20px] rounded-lg shadow-lg flex items-center justify-around xl:w-[600px] w-[300px] h-[100px]">
					...
					<div className="xl:w-[170px] w-[140px] h-[50px] bg-[var(--zen-base)] rounded-xl flex items-center justify-center cursor-pointer hover:bg-[var(--zen-lightorange)] transition-all duration-600 z-[2]">
						<a
							...
							target="_blank"
							className="gSans xl:text-[20px] text-[13px] text-[var(--zen-white)]"
						>
							Empieza Ahora
						</a>
					</div>

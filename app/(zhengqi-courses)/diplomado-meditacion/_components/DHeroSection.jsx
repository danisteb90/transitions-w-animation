...
const DHeroSection = () => {
	...
	return (
		<section className="w-full h-full bg-[var(--zen-analog2)] flex items-center justify-center">
			...
			<div className="absolute top-[50%] translate-y-[-50%] md:right-[4%] right-[50%] md:translate-x-0 translate-x-[50%] bg-[#000000ab] 2xl:w-6/12 xl:w-6/12 w-5/6 xl:h-[65%] h-[70%] rounded-2xl backdrop-blur-lg z-0 md:p-12 p-4">
